...
import { Item, List } from '../../utils/storage/functions/UserStorageFunctions';
...
const EditListScreen = () => {
  ...
  function editCheckItem(item: Item) {
    ...
    saveSelectedList({...selectedList, itens: selectedList.itens.map((e: any)=> e.id === item.id ? item : e)})
